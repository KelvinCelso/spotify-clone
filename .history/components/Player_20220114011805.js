...
import {SwitchHorizontalIcon,VolumeUpIcon, VolumeDownIcon
    ...
    return (
        <Container>
            ...
            <MiddleContent>
                ...
                <RewindIcon onClick={()=> spotifyApi.skipToPrevious()} className="icon"/>
                {isPlaying?(
                <PauseIcon onClick={handlePlayPause} className="icon2"/>
                ):(
                <PlayIcon onClick={handlePlayPause} className="icon2"/>
                )}
                <FastForwardIcon onClick={()=>spotifyApi.skipToNext()} className="icon"/>
